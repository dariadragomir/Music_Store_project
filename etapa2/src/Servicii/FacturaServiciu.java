...
public class FacturaServiciu implements FacturaServiciuInterfata {
    ...
    public void genereazaFactura(Comanda comanda, double total) {
        ...
        if(FacturaServiciu.getInstance().gasesteFactura(factura.getId()) != null) {
            System.out.println("Factura cu acest ID deja exista.");
        }
        else facturaRepository.create(factura);
    }
