...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            //proceseaza o comanda
            System.out.println("\nProcesare comanda 1:");
            Magazin.getInstance().proceseazaComanda(1);
            System.out.println(Magazin.getInstance().cautaComandaDupaId(1));
